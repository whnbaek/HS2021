...
void FPGA::convLowering(const std::vector<std::vector<std::vector<std::vector<float>>>>& cnn_weights,
   ...
   * new_weights: [conv_channel, input_channel x conv_height x conv_width]
   * inputs: [input_channel, input_height, input_width]
   * new_inputs: [input_channel x conv_height x conv_width, (input_height - conv_height + 1) * (input_width - conv_width + 1)]
   *
   */
